...
//     const {resName,cuisins,star,time} = props;
//   return (
//     <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
//       <img
//         className="res-logo"
//         src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/stcwjsd9zpxnbi8nnq8t"
//       />
//       <h3>{resName}</h3>
//       <h4>{cuisins}</h4>
//       <h4>{star}</h4>
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        ...
        {/* <RestaurantCard resName="Ali Food" cuisins="Biryani" star="4.6 star" time="35 minutes" /> */}
